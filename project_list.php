        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <a href="project_add.php" class="btn btn-link">เพิ่มข้อมูลเพลง</a>
                    ...
                    <?php
                        ...
                        $sql =  'SELECT * FROM project_detail order by prj_id';
                        $result = mysqli_query($conn,$sql);
                        while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
                            echo '<tr>';
                            echo '<td>' . $row['prj_id'] . '</td>';
                            echo '<td>' . $row['prj_name'] . '</td>';
                            echo '<td>' . $row['prj_unlname']. '</td>';
                            ...
                            ?>
                                ...
                                <a href="JavaScript:if(confirm('ยืนยันการลบ')==true)
                                   {window.location='project_delete.php?prj_id=<?php echo $row["prj_id"];?>'}" class="btn btn-danger">ลบ</a>
                            <?php
                                    echo '</td>';                            
                            echo '</tr>';
                        }
