        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    ...
                    <?php
                        $artart_id = $_REQUEST['artart_id'];
                        if(isset($_GET['submit'])){
                            $artart_art_id = $_GET['artart_art_id'];
                            $artart_arts_id = $_GET['artart_arts_id'];
                            $wkg_id = $_GET['wkg_id'];
                            $sql = "update art_detail set ";
                            $sql .= "artart_art_id='$artart_art_id',artart_arts_id='$$artart_arts_id',wkg_id='$wkg_id' ";
                            $sql .="where artart_id='$artart_id' ";
                            include 'connectdb.php';
                            mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            echo "แก้ไขข้อมูลนักร้อง $artart_art_id $artart_arts_id $wkg_id เรียบร้อยแล้ว <br>";
                    ...
                    <form class="form-horizontal" role="form" name="art_edit" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <div class="form-group">
                            ...
                            <label for="artart_art_id" class="col-md-2 col-lg-2 control-label">คำนำหน้า</label>
                            <div class="col-md-10 col-lg-10">
                                <select name="artart_art_id" id="artart_art_id" class="form-control">
                                <?php
                                    include 'connectdb.php';
                                    $sql2 = "select * from art_detail where ppl_id='$ppl_id'";
                        ...
                        <div class="form-group">
                            <label for="ppl_lname" class="col-md-2 col-lg-2 control-label">ชื่อค่าย</label>
                            <div class="col-md-10 col-lg-10">
